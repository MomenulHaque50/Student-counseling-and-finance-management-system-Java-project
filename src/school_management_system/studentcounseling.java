 ...
 */
public class studentcounseling extends javax.swing.JFrame {

    /**
     * Creates new form StudentsRegistration
     */
    public studentcounseling() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentcounseling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentcounseling().setVisible(true);
            }
        });
    }
