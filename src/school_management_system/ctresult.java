 ...
 */
public class ctresult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(763, 450));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ctresult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
